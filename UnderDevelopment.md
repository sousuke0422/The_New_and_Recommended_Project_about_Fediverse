...
・Technopolis<br>
公式サイト（OfficialSite）:https://technopolis.app/<br>
Gitリポジトリ（Git Repository): https://github.com/technopolis-microblog/Technopolis-Be<br>
開発者アカウント(Developer's account): @silverscat_3@norimono.moe <br>
 >Technopolis is a globally interconnected micro-blogging platform inspired by Misskey. <br>
 >テクノポリスは、必要な機能だけを実装した、軽量でエレガントな連携型マイクロブログプラットフォームを目指しています。<br><br>
...
　MrBotchiはお一人様向けの連合マイクロブログプラットフォームです。<br><br>

・Shrimoon<br>
開発原案(Plan for developing): https://scrapbox.io/xeltica/Shrimoon<br>
開発者アカウント(Developer's account): @ebi@misskey.io<br><br>
...
　Pleromaのホスティングサービスです。現在は開発中でαステージだそうです。<br><br>

# <div id="ProtocolandDocumentation"><b>9.プロトコルおよびドキュメント等(Protocol and Documentation)</b></div>
・Hash2Pub<br>
Gitリポジトリ（Git Repository): https://git.orlives.de/schmittlauch/Hash2Pub<br>
 >A DHT-based relay and post store for ActivityPub hashtags<br><br>

・Jejune<br>
https://ariadne.space/activity/6cfb07cab0f800f33ed2848fc0a1962e14349a7c43b6b0a9d04d1b7f2b85c12f/what-jejune-is-why-jejune-matters<br>
 >Jejune is a personal ActivityPub server. It is meant to serve as a possible building block for the microverse, which is a subset of the fediverse focused on small, personal instances.<br><br>
...
Gitリポジトリ（Git Repository): https://lab.fedeproxy.eu/fedeproxy<br>
 ...
 異なるgitリポジトリサービスでの、それぞれのissue等をActivityPubでシェアするサービスです。<br><br>
...
Gitリポジトリ（Git Repository): https://github.com/rzr/fediverse-action<br>
 ...
 Githubの特定のプロジェクトでコードの変更があると、それに関する通知がTLに流れます。現在マストドンでテストが行われています。<br><br>
...
　分散型のブログ記事の発行や引用等を行う、ActivityPubに対応したユーザー側のエディターです。<br><br>
